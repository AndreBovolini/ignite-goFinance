...
function getLastTransactionDate(collection: DataListProps[], type: 'positive' | 'negative') {
    ...
    async function loadTransaction() {
        ...
        const totalInterval = lastTransactionExpenses === 0 ? 'Não há transações' : `01 à ${lastTransactionExpenses}`
        ...
        setHighlightData({
            entries: {
                ...
                lastTransaction: lastTransactionEntries === 0 ? 'Não há trasações':`Última entrada dia ${lastTransactionEntries}`
            },
            expenses: {
                ...
                lastTransaction: lastTransactionExpenses === 0 ? 'Não há trasações':`Última saída dia ${lastTransactionExpenses}`
            },
            total: {
